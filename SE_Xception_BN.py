...
def SE_Xception(include_top=False, weights='imagenet', input_shape=(299,299,3),input_tensor=None):
    ...
    if include_top:
         ...
         y=BatchNormalization()(SqueezeAndExcitation(s,'Se1'))#squeeze excitation to entry block
         z=BatchNormalization()(SqueezeAndExcitation(f,'Se2')) #squeeze excitation to middle flow
         q=BatchNormalization()(SqueezeAndExcitation(x,'Se3'))
